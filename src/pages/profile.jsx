  ...
  if (!currentUser) {
    return (
      <div className="dashboard-container">
        <div className="auth-alert text-center">
    ...
    <div className="dashboard-container">
      <header className="profile-header">
        ...
        <p className="user-welcome">
          Keep your skills up to date to find better matches.
        </p>
      </header>
        ...
        <div className="skills-management">
          ...
          <div className="card card-secondary profile-manage-card">
            ...
            <div className="skill-input-group">
              ...
              />
              <button onClick={handleAddTeach} className="add-btn teach-add">
                Add
              </button>
            </div>
            ...
            <div className="skill-tags-cloud">
              {teachSkills.map((skill, index) => (
                <div key={index} className="tag teach-tag-removable">
                  {skill.name}
                  <button onClick={() => dispatch(removeTeachSkill(skill._id))}>
                    ✕
                  </button>
                </div>
              ))}
          ...
          <div className="card card-secondary profile-manage-card">
            ...
            <div className="skill-input-group">
              ...
              />
              <button onClick={handleAddLearn} className="add-btn learn-add">
                Add
              </button>
            </div>
            ...
            <div className="skill-tags-cloud">
              {learnSkills.map((skill, index) => (
                <div key={index} className="tag learn-tag-removable">
                  {skill.name}
                  <button onClick={() => dispatch(removeLearnSkill(skill._id))}>
                    ✕
                  </button>
                </div>
              ))}
